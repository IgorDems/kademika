...
public class PrintTankInfo {
	...
	public static void main(String[] args) {
		...
		tanks[0] = new Tank();// значение из конструктора classTank с пустыми
								// параметрами, которые заданы непосредственно в
								// конструкторе Tank() =classTank=
		...
		while (i <= 4) {
			System.out.printf("%s\t%d\t%d\n", tanks[i].color, tanks[i].crew,
					tanks[i].maxSpid);// ссылка на элемент массива
